...
Ported code is released under the [MIT](https://github.com/nickburkhart/go-gesclient/blob/master/LICENSE) license.
...
1. Install using `go get -u github.com/nickburkhart/go-gesclient`.
